...
#include <string.h>
#include <stdlib.h>
#include "C:\\Personal Projects\\SkillHub Manager\\Project_Flies\\include\\adminLogin.h"
#include "C:\\Personal Projects\\SkillHub Manager\\Project_Flies\\include\\facultyLogin.h"
...
int main()
{
    int choice;
    cout << "\n\n--------------------------------------------------------------------" << endl;
    cout << "              SkillHub Training Schedule Management System                  " << endl;
    cout << "--------------------------------------------------------------------" << endl;
...
void facultyLogin()         //UTC-007 & AA-001
{
    ...
    ifstream input("C:\\Personal Projects\\SkillHub Manager\\Project_Flies\\include\\facultyLogin.h");
